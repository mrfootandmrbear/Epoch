...
The two grazer populations now carry stable identities and renderer-independent trait means derived from the habitat at their resolved sites. Wet, sheltered ground and exposed, rugged ground shape body mass, leg and foot proportions, insulation, coat, and horns. The accepted marsh-grazer expresses those means through per-instance morph weights and stable cosmetic sampling, with one instanced draw per lineage and terrain-aware locomotion. Its revised silhouette, island integration, and live motion passed owner review on 2026-08-12. Trait inheritance, migration, energy, abundance, extinction, and bounded deep-time branching persist across successive jumps.

The jump resolver now captures one immutable sampled `WorldSnapshot` before resolving life. Terrestrial habitat, drainage-fed freshwater pools, shallow-water productivity, nesting ground, and wind lift all read that same terrain and climate state. Grazers separate across land habitats; one coastal-forager fish lineage persists through a coarse connected water volume with surface, midwater, and benthic bands, body-size clearance, depth choice, maneuverability, depth control, energy, abundance, migration, adaptation, and extinction independently of its landing renderer. A separate benthic field describes coral-facing seabed rather than treating coral as a swimming population. Marine primary productivity, nursery capacity, prey, and shoreline subsidy are explicit shared energy signals for later aerial and terrestrial consumers. These are the first connected terrestrial, freshwater, marine, and aerial outcomes—not final ecosystem breadth, but the shared substrate future populations will extend.

The first fish candidate, `epoch-coastal-forager`, now replaces that primitive swimmer. One instanced, topology-stable family expresses body size, streamlining, maneuverability, depth control, thermal adaptation, energy condition, resolved water band, and a tail-driven swim cycle without making individual fish persistent simulation state. Its fixed owner-review view is `?shot=fish&fixture=mature-warm-reef&fish=candidate&time=42`.

Terrain change accumulates between jumps instead of being recalculated from the original island. The current resolver preserves inherited elevations, drainage, substrate, disturbance, vegetation protection, sediment, volcanism, and reef carbonate. Its generic deep-time magnitude is now exploratory: Epoch is realigning around fixed-hotspot, moving-crust Galápagos-style shield history before accepting the upper jump ladder.

World initialization is explicit before the first jump. The existing rainfall × temperature fixtures remain useful coverage, but the canonical world is one Galápagos-inspired hotspot archipelago. Regional variation comes from shield age, elevation, trade-wind exposure, rainfall/garúa, upwelling, sea level, drainage, volcanism, substrate age, disturbance, and succession. Sediment and reef-produced carbonate remain persistent terrain history rather than renderer proximity effects. See `docs/GALAPAGOS-HOTSPOT-PLAN.md`.
