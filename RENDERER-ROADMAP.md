...
| Volcanic island history | **Experimenting** | A fixed player-placed hot spot accretes a bounded shield; a small output-sensitive lava marker preserves causal legibility. Persistent surface age and soil development now separate fast wet-climate succession from slow arid recovery, active vents leave recent flows at the landing, deterministic downhill flows resurface capped terrain, and retained volcanic load drives deep-time subsidence after extinction. | Capture the same vent as fresh flow, wet/arid recovery, carved island, and drowned remnant; tune life-cycle pacing and flow silhouettes from those frames. |
